 ...
 * @author hp
 */
public class ViewBerhasilOrder extends javax.swing.JFrame {
    ImageIcon icon = new ImageIcon("src/img/logo.png");

    Timer timer;
    int count = 5;
    public ViewBerhasilOrder() {
        initComponents();
            ...
            public void run() {
                if (count <= 0) {
                    try {
                        ...
                        Logger.getLogger(ViewBerhasilOrder.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/happy.png"))); // NOI18N

        jLabel19.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel19.setText("Pesanan Anda akan segera kami proses");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBerhasilOrder().setVisible(true);
            }
        });
    }
